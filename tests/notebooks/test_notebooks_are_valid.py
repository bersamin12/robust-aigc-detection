...
EXPECTED_NOTEBOOKS = (
    ...
    "kaggle_canon_ablation.ipynb",   # crop vs band vs crop_geo, one sub-manifest
    # The backbone probe: ONE MODEL PER NOTEBOOK, generated by
    # scripts/build_probe_notebooks.py so the eleven shared bootstrap cells
    # cannot drift apart across four hand-maintained copies.
    "kaggle_probe_dinov2regl.ipynb",
    "kaggle_probe_eva02l.ipynb",
    "kaggle_probe_convnextv2h.ipynb",
    "kaggle_probe_siglipso400m.ipynb",
)
